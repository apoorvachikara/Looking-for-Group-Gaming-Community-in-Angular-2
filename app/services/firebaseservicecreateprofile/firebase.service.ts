...
export class FirebaseService {
  ...
  constructor (private _http: Http) { }
    ...
    //Adding profile of user on Firebase DB

    setUser (name: string, age: number, characters: Array<any>,gamename: string, platformname: string, playerid: string, playertimeweekdaysfrom: string, playertimeweekdaysto: string, playertimeweekendsfrom: string, playertimeweekendsto: string, playertimezone: string ){
      this.user = playerid;
      console.log(this.user)
      this.url= "https://gaming-community-9270c.firebaseio.com/user/" + this.user + ".json";
  ...
  //Getting user data 
    getUser(){
        ...
        return this._http.get('https://gaming-community-9270c.firebaseio.com/user.json')
                  .map(response => response.json());
    ...
    getMembercount(){
          ...
          return this._http.get('https://gaming-community-9270c.firebaseio.com/usercount.json')    
                      .map(response => response.json());
    }
    
    //Adding user under Specific name of Game
    
    adduserinGame(gamename : string, name: string){
    ...
    //Adding User under specific platforms
    addUserinPlatform(gamenameforplatform: string, usernameforplatform: string, platformname: string){
